...
export default function FilterDropdown({options, selected, setSelected}) {
  ...
  if (options) {
    return (
      <div as="div" className="relative inline-block text-left w-full">
        <div>
          <div onClick={e => (setShow(!show))} className="cursor-pointer inline-flex justify-between items-center w-full h-12 ">
